...
const AddInstructions = () => {
	...
	const { fields, append, remove } = useFieldArray({ name: "instructions", control });
			...
			<div className="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left">
				...
				<section className="pb-4">
					{fields.map((instruction, index) => (
						<div key={instruction.id} className="relative mt-6 sm:pr-4">
							...
							<div className="mt-4 sm:ml-96 md:pl-14">
